...
def about():
    showinfo("About this program","This is a program written by Abate Agegenhu")
...
#this is for full sccreen width and height of the pc 
# window.geometry("{}x{}+{}+{}".format(screen_width,screen_height,x,y))
